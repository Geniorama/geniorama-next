...
export default function PoliticaDePrivacidad() {
  return (
    <Layout
      title={"Política de privacidad - Geniorama"}
      idPage={"gen-politica-privacidad"}
    >
      <div className="mt-5">
        <HeadingPage
          sTitle={"PROTEGEMOS TU INFORMACIÓN"}
          lTitle={"POLÍTICA DE PRIVACIDAD"}
        />
      </div>
      <section className="container my-5">
        ...
        <p>
          ...
          Geniorama Agencia S.A.S usa y protege la información que es
        ...
        <p>
          Geniorama Agencia S.A.S está altamente comprometido para cumplir con
        ...
        <p>
          ...
          mayoría de navegadores aceptan cookies automáticamente pues sirve para
        ...
        <p>
          Geniorama Agencia S.A.S Se reserva el derecho de cambiar los términos
