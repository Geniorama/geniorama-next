            ...
            <div className={styles.genPortfolioGrid}>
                {
                    info.map((post) => (
                        ...
                        <div key={post.id}  data-aos="zoom-in" data-aos-duration="1000" className={styles.genPortfolioGrid__item}>
                            <a href={post.acf.link ? post.acf.link.url : "#"} target={post.acf.link ? post.acf.link.target : ""} rel="noopener" title={post.acf.link ? post.acf.link.title : ""} className={styles.genPortfolioLink}>
